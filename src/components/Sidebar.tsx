...
export default function Sidebar({ user, activeTab, setActiveTab, onLogout }: SidebarProps) {
  ...
  return (
    <aside id="sidebar-menu" className="w-64 bg-neutral-950 border-l border-neutral-900 flex flex-col h-screen fixed right-0 top-0 text-right no-print z-40">
      
      {/* Brand Logo Header */}
      <div className="p-6 border-b border-neutral-900 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-full bg-blue-600 animate-pulse" />
          <h1 className="text-2xl font-extrabold tracking-widest text-white font-sans">
            LUMÉRÉ
          </h1>
        </div>
